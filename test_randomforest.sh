...
/usr/local/spark/bin/spark-submit --class CensusIncome3 --master=spark://$SPARK_MASTER:7077 target/LogisticRegressionWithElasticNetExample-1.0-SNAPSHOT.jar hdfs://$SPARK_MASTER:9000/user/root/data/mllib/train.csv hdfs://$SPARK_MASTER:9000/user/root/data/mllib/test.csv
mvn clean
