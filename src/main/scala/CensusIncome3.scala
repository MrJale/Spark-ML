...
object CensusIncome3{
  ...
  def main (args: Array[String]){
    ...
    val spark = SparkSession.builder.appName("CensusIncome3").master("local[*]").getOrCreate()
    ...
    val RandomForestClassificationModel = RandomForestClassifier.fit(labelTrain)

    val predictions = RandomForestClassificationModel.transform(labelTest)
    predictions.show(10)
